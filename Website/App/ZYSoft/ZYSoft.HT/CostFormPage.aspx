									...
									<tr>
										...
										<td>
											<el-form-item label="利润年度" class="form-item-max" prop='year'>
												...
												<el-input :readonly="query.state =='read'" clearable style="width:100%"
													v-model="form.year" placeholder="请填写利润年度"
										...
										<td>
											<el-form-item label="竣工时间" class="form-item-max" prop='endDate'>
												...
												<el-input :readonly="query.state =='read'" clearable style="width:100%"
													v-model="form.endDate" placeholder="请填写竣工日期"
													class="noBorder"></el-input>
											</el-form-item>
										</td>
									</tr>
										...
										<td>
											<el-form-item label="主合同净收入" class="form-item-max moneyright" prop='sum'>
												<el-input-number :disabled="query.state =='read'" style="width:100%"
													:controls=false v-model="form.sum" :min=0 :precision="2" v-thousands
													placeholder="请填写主合同净收入" class="noBorder"></el-input-number>
											</el-form-item>
										</td>
										<td>
											<el-form-item label="项目经理" class="form-item-max" prop='manager'>
												<span slot='label'
													id='ele_manager'>项&nbsp;&nbsp;目&nbsp;&nbsp;经&nbsp;&nbsp;理</span>
												<el-input :readonly="query.state =='read'" clearable style="width:100%"
													v-model="form.manager" placeholder="请填写项目经理"
													class="noBorder"></el-input>
											</el-form-item>
										</td>
									</tr>
									<tr>
										<td>
											<el-form-item label="合同号" class="form-item-max1" prop='contractNo'>
												...
												<el-input :readonly="query.state =='read'" clearable style="width:100%"
													v-model="form.contractNo" placeholder="请填写合同号"
													class="noBorder"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item label="从属合同、增补合同合计" class="form-item-max moneyright"
												prop='addSum'>
												<el-input-number :disabled="query.state =='read'" style="width:100%"
													:controls=false v-model="form.addSum" :min=0 :precision="2"
													v-thousands placeholder="请填写增补金额"
													class="noBorder"></el-input-number>
											</el-form-item>
										</td>
										<td>
											<el-form-item label="客户项目经理" class="form-item-max" prop='custManager'>
												<el-input :readonly="query.state =='read'" clearable style="width:100%"
													v-model="form.custManager" placeholder="请填写客户项目经理"
													class="noBorder"></el-input>
											</el-form-item>
										</td>
									...
									<tr>
										<td>
											<el-form-item label="项目类型" class="form-item-max1" prop='projectType'>
												<el-input :readonly="query.state =='read'" clearable style="width:100%"
													v-model="form.projectType" placeholder="请填写项目类型"
													class="noBorder"></el-input>
											</el-form-item>
										</td>
										<td>
											<el-form-item label="合同净收入" class="form-item-max moneyright">
												...
												<el-input-number style="width:100%;" v-thousands disabled
													:controls=false v-model="form.totalSum" :min=0 :precision="2"
													placeholder="请填写增补金额" class="noBorder"></el-input-number>
											</el-form-item>
										</td>

										<td>
											<el-form-item label="净成本" class="form-item-max moneyright">
												<span
													slot='label'>净&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;成&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本</span>
												<el-input-number style="width:100%;" disabled :controls=false
													v-thousands v-model="form.cost" :min=0 :precision="2"
													placeholder="请填写净成本" class="noBorder"></el-input-number>
											</el-form-item>
										</td>

										<td>
											<el-form-item label="利润" class="form-item-max moneyright">
												<span
													slot='label'>利&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;润</span>
												<el-input-number style="width:100%;" v-thousands disabled
													:controls=false v-model="form.profit" :precision="2"
													placeholder="请填写利润" class="noBorder"></el-input-number>
											</el-form-item>
										</td>
									</tr>
								</table>
						...
						<el-col :span=8 v-if="summary.length>0" style="height:150px;overflow-y:scroll">
							<table border='1' style="text-align: center">
								...
								<tr :class="t.FGroupCode == activeName ? 'hightRow' : '' " v-for='t in summary'
									...
									<td style="width:150px;padding:10px">
										<el-tooltip class="item" effect="dark" content="点击查看详情" placement="right">
											<span v-if='t.FIsTotal == 1'>
												{{t.FGroupCode}}</span>
											<a v-else :class="t.FGroupCode == activeName ? 'hightRow' : '' "
									...
									<td style="width:150px;padding:10px"><el-input size="small" class="noBorder_all"
											disabled v-thousands type="text" v-model="t.FSum"></td>
								</tr>
							</table>
						</el-col>
					</el-row>
								...
								<table v-if='tab.FIsSp == 1' border='1' style="text-align: center">
									<thead>
										<tr style="background-color: #e6e6e6;">
											...
											<th style="width:200px;padding:8px">从属合同、增补合同净收入</th>
									...
									<tr class="tr" v-for='t in contractList' :key='t.FEntryID'>
										...
										<td style="width:250px;padding:10px">
											<el-input size="small" class="noBorder_all" disabled v-thousands type="text"
												v-model="t.FSum">
										</td>
										<td style="width:250px;padding:10px">
											<el-input size="small" class="noBorder_all" disabled v-thousands type="text"
												v-model="t.ContractAmount">
										</td>
