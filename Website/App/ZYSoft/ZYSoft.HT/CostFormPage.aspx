					...
					<el-tabs type="border-card" v-model="activeName">
						<el-tab-pane v-for='tab in tabs' :key='tab.FGroupCode' :name="tab.FGroupCode" :label="tab.FGroupName">
							...
							<table v-if='tab.FIsSp == 1' border='1' style="text-align: center">
								<thead>
									<tr>
										<th style="width:250px;padding:8px">合同号</th>
										<th style="width:250px;padding:8px">总金额</th>
										<th style="width:250px;padding:8px">项目</th>
									</tr>
								</thead>
								<tr class="tr" v-for='t in contractList' :key='t.FContractNo'>

									<td style="width:150px;padding:10px">{{t.FContractNo}}</td>
									<td style="width:150px;padding:10px">{{t.FSum}}</td>
									<td style="width:250px;padding:10px">{{t.FProject}}</td>
