                        ...
                        <el-form ref="form" :rules="rules" :model="form" label-width="100px" size="mini" inline>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <el-form-item label="年份" class="form-item-max" prop='contractNo'>
                                            <el-input :readonly="query.state =='read'" clearable style="width:100%" v-model="form.year" placeholder="请填写年份" class="noBorder"></el-input>
                                        </el-form-item>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <el-form-item label="差异金额" class="form-item-max moneyright" prop='sum'>
                                    ...
                                    <td>
                                        <el-form-item label="差异增补金额" class="form-item-max moneyright" prop='addSum'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <el-form-item label="竣工实际" class="form-item-max" prop='endDate'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <el-form-item label="制单人" class="form-item-max" prop='billerName'>
                                            <el-input :readonly="query.state =='read'" style="width:100%" v-model="form.billerName" placeholder="请填写制单人" class="noBorder"></el-input>
                                        </el-form-item>
                                    </td>
                                </tr>
                            </table>
