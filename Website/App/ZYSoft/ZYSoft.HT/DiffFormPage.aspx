						...
						<el-form ref="form" :rules="rules" :model="form" label-width="100px" size="mini" inline>
							<table>
								...
								<tr>
									...
									<td>
										<el-form-item label="净成本" class="form-item-max moneyright" prop='sum1'>
											<el-input-number :disabled="query.state =='read'" style="width:100%" :controls=false v-model="form.sum1" :min=0 :precision="2" placeholder="请填写净成本" class="noBorder"></el-input-number>
										</el-form-item>
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<el-form-item label="预算金额" class="form-item-max moneyright" prop='budgetSum'>
											<el-input-number :disabled="query.state =='read'" style="width:100%" :controls=false v-model="form.budgetSum" :min=0 :precision="2" placeholder="请填写预算金额" class="noBorder"></el-input-number>
										</el-form-item>
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<el-form-item label="差异总金额" class="form-item-max moneyright">
											<span slot='label'>差异总额</span>
							...
							<tr :class="t.FGroupCode == activeName ? 'hightRow' : '' " v-for='t in summary' :key='t.FGroupCode' :id='t.FGroupCode'>
								...
								<td style="width:150px;padding:10px">
									<el-tooltip class="item" effect="dark" content="点击查看详情" placement="right">
										<a :class="t.FGroupCode == activeName ? 'hightRow' : '' " @click='showGroupDetail(t)' style="cursor: pointer;text-decoration: underline;">
											{{t.FGroupCode}}</a>
									</el-tooltip>
								</td>
