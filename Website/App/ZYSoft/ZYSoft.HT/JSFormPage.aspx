					...
					<el-col :span=24 style="overflow-x:auto">
						<el-form ref="form" :rules="rules" :model="form" label-width="100px" size="mini" inline>
							<table>
								<tr>
									<td>
										<el-form-item label="单号" class="form-item-max" prop='billNo'>
								...
								<tr>
									...
									<td>
										<el-form-item label="总金额" class="form-item-max moneyright">
											<el-input-number style="width:100%;" disabled :controls=false v-model="form.sum" :min=0 :precision="2" placeholder="请填写增补金额" class="noBorder"></el-input-number>
										</el-form-item>
									</td>
								</tr>
