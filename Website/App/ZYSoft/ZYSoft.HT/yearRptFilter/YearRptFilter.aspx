<%@ Page Language="C#" AutoEventWireup="true" %>
    ...
    <head runat="server">
        ...
        <link href="./yearRptFilter.css" rel="stylesheet" />
    ...
    <body>
                ...
                <el-col :push="1" :span="20" :pull="1">
                    <el-form ref="form" :model="form" label-width="100px" size="mini" inline>
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <el-form-item label="年度区间" class="form-item-max" prop='yearPeriod'
                                        style="margin-bottom: 0px !important;">
                                        <el-input clearable style="width:100%" v-model="form.yearPeriod"
                                            placeholder="请填写年度区间" class="noBorder"></el-input>
                                    </el-form-item>
                                </td>
                            </tr>
                        </table>
        ...
        <script src="./yearRptFilter.js"></script>
    </body>
