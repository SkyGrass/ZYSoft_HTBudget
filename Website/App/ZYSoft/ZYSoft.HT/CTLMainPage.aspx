...
<body>
	...
	<div id="app">
			...
			<el-main class="manin">
				<el-container class="contain">
							...
							<el-row>
								<el-col :span="8">
									<el-form-item label="日期">
										<el-date-picker style="width:100%" v-model="form.date" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
										</el-date-picker>
									</el-form-item>
								</el-col>
							</el-row>
					...
					<el-main :style="{height:maxHeight+'px',padding:0}">
						<div style="width:100%">进货单 <div id="grid_in"></div>
						</div>
						<div style="width:100%">调拨单 <div id="grid_trans"></div>
						</div>
						<div style="width:100%">材料出库 <div id="grid_out"></div>
						</div>
					</el-main>
				</el-container>
			</el-main>
		...
		<el-dialog title="标志人查询：" :visible.sync="markerVisible">
			...
			<el-table :data="markersList" tooltip-effect="dark" :height="maxHeight" style="width: 100%" highlight-current-row @row-click="handleMarkerSelectionChange">
		...
		<el-dialog title="物料查询：" :visible.sync="materialVisible">
			...
			<el-table :data="materialList" tooltip-effect="dark" :height="maxHeight" style="width: 100%" highlight-current-row @row-click="handleMaterialSelectionChange">
