                        ...
                        <el-form ref="form" :rules="rules" :model="form" label-width="100px" size="mini" inline>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <el-form-item label="预算金额" class="form-item-max moneyright" prop='addSum'>
                                            <el-input-number :disabled="query.state =='read'" style="width:100%" :controls=false v-model="form.addSum" :min=0 :precision="2" placeholder="请填写预算金额" class="noBorder"></el-input-number>
                                        </el-form-item>
                                    </td>
